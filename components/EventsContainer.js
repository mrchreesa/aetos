    ...
    return (
      ...
      >
        <Flex direction={{ base: "column", lg: "row" }} align="center">
          <Flex>
            <Box
              w={{ base: "full", sm: tabData.imageMobile.width / 2 }}
              h={{ base: "full", sm: tabData.imageMobile.height / 2 }}
              shadow="2xl"
            ...
            >
              <NextImage
                ...
                width={tabData.imageMobile.width / 2}
                height={tabData.imageMobile.height / 2}
